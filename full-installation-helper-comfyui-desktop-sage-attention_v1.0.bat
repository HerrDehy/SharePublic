@echo off
chcp 65001 >nul
title Triton and ComfyUI Desktop with SageAttention Installation Helper - full ComfyUI Desktop version

echo Welcome to the ComfyUI Desktop, Triton and SageAttention installation helper utility - full ComfyUI Desktop version
echo.
color 0E
echo ====================================================
...
color 07
echo.
echo 1. This utility is a FULL installation of ComfyUI Desktop with ComfyUI-Manager and SageAttention.
echo 2. This utility can be placed anywhere you want, ComfyUI folder will be created there.
